const productos=[
   /* {id:1, sku: '0000001', nombre:'Computadora Portátil de 15 Pulgadas', precio:1399, precioOferta: 1099, categoria: 'PC', descripcion: 'Computadora portátil con procesador de alto rendimiento, pantalla de 144Hz y teclado retroiluminado. Incluye memoria RAM de 16GB y disco de estado sólido.', imagen: 'img/laptop.png'},
    ...
    {id:5, sku: '0000005', nombre:'Monitor de 27 Pulgadas', precio:299, precioOferta: 259, categoria: 'PC', descripcion: 'Monitor de 27 pulgadas con panel IPS, resolución Full HD y frecuencia de actualización de 144Hz.', imagen: 'img/monitor.png'},
    {id:6, sku: '0000006', nombre:'Ratón Inalámbrico USB Pro X', precio:60, precioOferta: 3 40, categoria: 'PC', descripcion: 'Ratón inalámbrico con sensor óptico, diseño ergonómico y batería recargable integrada.', imagen: 'img/mouse.png'},
    {id:7, sku: '0000007', nombre:'Cámara Web 1080p', precio:75, precioOferta: 55, categoria: 'PC', descripcion: 'Cámara web con resolución 1080p, conexión USB y micrófono estéreo incorporado para videollamadas.', imagen: 'img/webcam.svg'},
    {id:8, sku: '0000008', nombre:'Micrófono de Condensador Studio Pro', precio:130, precioOferta: 89, categoria: 'Audio', descripcion: 'Micrófono de condensador con patrón polar cardioide, base de escritorio y conexión USB.', imagen: 'img/mic.svg'},
    {id:9, sku: '0000009', nombre:'Consola de Videojuegos Doméstica', precio:499, precioOferta: 399, categoria: 'Gaming', descripcion: 'Consola de videojuegos doméstica con unidad de estado sólido interno y mando inalámbrico incluido.', imagen: 'img/console.svg'},
    {id:10, sku: '0000010', nombre:'Silla de Escritorio Ergonómica', precio:250, precioOferta: 199, categoria: 'Gaming', descripcion: 'Silla de escritorio con diseño ergonómico, soporte lumbar ajustable y respaldo reclinable.', imagen: 'img/chair.svg'},
    {id:11, sku: '0000011', nombre:'Tableta de 10 Pulgadas', precio:320, precioOferta: 289, categoria: 'Tablet', descripcion: 'Tableta electrónica de 10 pulgadas con pantalla táctil, conectividad Wi-Fi y cámaras frontal y trasera.', imagen: 'img/tablet.svg'},
    {id:12, sku: '0000012', nombre:'Reloj Inteligente Deportivo', precio:199, precioOferta: 189, categoria: 'Wearable', descripcion: 'Reloj inteligente con conectividad Bluetooth, monitor de frecuencia cardíaca y resistencia al agua.', imagen: 'img/watch.svg'},
    {id:13, sku: '0000013', nombre:'Audífonos Inalámbricos Básicos', precio:199, precioOferta: 129, categoria: 'Audio', descripcion: 'Audífonos inalámbricos intrauditivos con conectividad Bluetooth y estuche de carga recargable.', imagen: 'img/p1.png'}
];
